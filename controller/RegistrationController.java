...
import com.mysite.domain.dto.CaptchaResponseDto;
...
public class RegistrationController {
    ...
    public String addUser(
        ...
        if (isConfirmEmpty) {
            model.addAttribute("password2Error", "Не нужны тебе новые ощущения!");
}
    ...
    public String activate(Model model, @PathVariable String code) {
        ...
        if (isActivated) {
            ...
            model.addAttribute("message", "Successfully activated account!");
//            model.addAttribute("changedRole", "1");
